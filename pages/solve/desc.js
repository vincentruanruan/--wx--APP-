...
Page({
  ...
  categoryChange: function(e) { // 切换新闻类型
    ...
    if (prevPage.route == 'pages/solve/index') { //如果是新闻页面进入的
      prevPage.setData({
        categoryAction: id
      })
      wx.navigateBack()
  ...
  getData: function(id) {
    ...
    this.scrollTop()
    wx.request({
      url: app.globalData.baseUrl + 'web/index.php?c=account&a=welcome&do=solvedetailapi',
      data: {
        id: id,
      },
      success(res) {
